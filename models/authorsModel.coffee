...
exports.update = (author, callback) ->
  authors.insert { _id: author.author_id, _rev: author.author_rev, timestamp: author.author_timestamp, name: author.author_name, fullname: author.author_fullname, deathdate: author.author_deathdate, birthdate: author.author_birthdate,nationality: author.author_nationality, mainlanguage: author.author_mainlanguage, birth_place: author.author_birth_place },(err, body) ->
    callback err, body
  return
